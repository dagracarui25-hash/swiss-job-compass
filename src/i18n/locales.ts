...
export const translations: Record<Language, TranslationKeys> = {
  ...
  en: {
    ...
    heroTitle: "Your Expert ORP, Benefits & Social Aid Assistant",
    heroSubtitle: "Get immediate answers about your unemployment rights, benefits payments, and social aid measures. Ask your question below.",
    heroPlaceholder: "Ask your question about ORP, benefits, or social aid here...",
    heroWelcome: "Hello! I'm your specialized virtual assistant. I can help you navigate between your ORP obligations, unemployment fund payments, and social aid rights. Ask me your question!",
    quickCalcIndemnites: "Calculate benefits",
    quickDelaisRecherche: "Job search",
    quickFormation: "Subsidiary social aid",
    quickContester: "Contest a decision",
    legalDisclaimer: "Disclaimer: Responses are AI-generated for informational purposes only. They do not replace official decisions from the ORP, the Unemployment Fund, or the competent social services.",
  },
  pt: {
    ...
    heroTitle: "Seu Assistente Especialista ORP, Caixa & Ajuda Social",
    heroSubtitle: "Obtenha respostas imediatas sobre seus direitos ao desemprego, indemnizações da Caixa e medidas de ajuda social. Faça sua pergunta abaixo.",
    heroPlaceholder: "Faça sua pergunta sobre o ORP, a Caixa ou a ajuda social aqui...",
    heroWelcome: "Olá! Sou seu assistente virtual especializado. Posso ajudá-lo a navegar entre suas obrigações ORP, pagamentos da Caixa de Desemprego e seus direitos à ajuda social.",
    quickCalcIndemnites: "Cálculo das indemnizações",
    quickDelaisRecherche: "Procura de emprego",
    quickFormation: "Ajuda social subsidiária",
    quickContester: "Contestar uma decisão",
    legalDisclaimer: "Aviso: As respostas são geradas por IA a título informativo. Não substituem as decisões oficiais do ORP, da Caixa de Desemprego ou dos serviços sociais competentes.",
  },
  es: {
    ...
    heroTitle: "Su Asistente Experto ORP, Caja & Ayuda Social",
    heroSubtitle: "Obtenga respuestas inmediatas sobre sus derechos al desempleo, indemnizaciones de Caja y medidas de ayuda social. Haga su pregunta a continuación.",
    heroPlaceholder: "Haga su pregunta sobre la ORP, la Caja o la ayuda social aquí...",
    heroWelcome: "¡Hola! Soy su asistente virtual especializado. Puedo ayudarle a navegar entre sus obligaciones ORP, pagos de la Caja de Desempleo y sus derechos a la ayuda social.",
    quickCalcIndemnites: "Cálculo de indemnizaciones",
    quickDelaisRecherche: "Búsqueda de empleo",
    quickFormation: "Ayuda social subsidiaria",
    quickContester: "Impugnar una decisión",
    legalDisclaimer: "Aviso: Las respuestas son generadas por IA con fines informativos. No sustituyen las decisiones oficiales de la ORP, de la Caja de Desempleo o de los servicios sociales competentes.",
  },
  sq: {
    ...
    heroTitle: "Asistenti juaj ekspert ORP, Arka & Ndihma Sociale",
    heroSubtitle: "Merrni përgjigje të menjëhershme mbi të drejtat tuaja të papunësisë, dëmshpërblimet e Arkës dhe masat e ndihmës sociale. Bëni pyetjen tuaj më poshtë.",
    heroPlaceholder: "Bëni pyetjen tuaj për ORP, Arkën ose ndihmën sociale këtu...",
    heroWelcome: "Përshëndetje! Jam asistenti juaj virtual i specializuar. Mund t'ju ndihmoj të navigoni ndërmjet detyrimeve ORP, pagesave të Arkës së Papunësisë dhe të drejtave tuaja për ndihmë sociale.",
    quickCalcIndemnites: "Llogaritja e dëmshpërblimeve",
    quickDelaisRecherche: "Kërkimi i punës",
    quickFormation: "Ndihma sociale subsidiare",
    quickContester: "Kontestoni një vendim",
    legalDisclaimer: "Paralajmërim: Përgjigjet janë gjeneruar nga IA për qëllime informative. Ato nuk zëvendësojnë vendimet zyrtare të ORP, Arkës së Papunësisë ose shërbimeve sociale kompetente.",
  },
  ar: {
    ...
    heroTitle: "مساعدك الخبير في ORP والصندوق والمساعدة الاجتماعية",
    heroSubtitle: "احصل على إجابات فورية حول حقوقك في البطالة وتعويضات الصندوق وإجراءات المساعدة الاجتماعية. اطرح سؤالك أدناه.",
    heroPlaceholder: "اطرح سؤالك حول ORP أو الصندوق أو المساعدة الاجتماعية هنا...",
    heroWelcome: "مرحباً! أنا مساعدك الافتراضي المتخصص. يمكنني مساعدتك في التنقل بين التزامات ORP ومدفوعات صندوق البطالة وحقوقك في المساعدة الاجتماعية. اطرح سؤالك!",
    quickCalcIndemnites: "حساب التعويضات",
    quickDelaisRecherche: "البحث عن عمل",
    quickFormation: "المساعدة الاجتماعية الفرعية",
    quickContester: "الطعن في قرار",
    legalDisclaimer: "تنبيه: يتم إنشاء الإجابات بواسطة الذكاء الاصطناعي لأغراض إعلامية فقط. لا تحل محل القرارات الرسمية لـ ORP أو صندوق البطالة أو الخدمات الاجتماعية المختصة.",
  },
};
